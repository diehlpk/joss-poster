...
\block{}{
  \begin{center}
   ...
   \small \textbf{Patrick Diehl}, \textbf{Daniel S.~Katz}, Gabriela Alessio Robles, Stefan Appelhoff, Jack Atkinson, Warrick Ball, Mojtaba Barzegari, Johanna Bayer, Juanjo Bazán, Sophie Beck, Sebastian Benthall, Monica Bobra, Frederick Boehm, Sébastien Boisgérault, Josh Borrow, Teon Brooks, Jed Brown, Philip Cardiff, Taher Chegini, Beatriz Costa Gomes, Pierre de Buyl, Renata Diaz, Axel Donath, Elizabeth DuPre, Matthew Feickert, Vissarion Fisikopoulos, Martin Fleischmann, Samuel Forbes, Dan Foreman-Mackey, James Gaboardi, William Gearty, Nikoleta Glynatsi, Jeff Gostick, Rohit Goswami, Olivia Guest, Jayaram Hariharan, Susan Holmes, Luiz Irber, Mark A. Jensen, Adam R. Jensen, Prashant Jha, Sehrish Kanwal, Vincent Knight, Olexandr Konovalov, Rachel Kurchin, Paul La Plante, Oskar Laverny, Hugo Ledoux, Richard Littauer, Michael Mahoney, Brian McFee, Rocco Meli, Sarath Menon, Antonia Mey, Tristan Miller, Kevin M. Moerman, Ivelina Momcheva, Yasmin Mzayek, Kanishka B. Narayan, Kyle Niemeyer, Lorena Pantano, AHM Mahfuzur Rahman, Julia Romanowska, Kelly Rowland, Anjali Sandip, Mehmet Hakan Satman, Jonny Saunders, Fabian Scheipl, Jacob Schreiber, Hauke Schulz, Adi Singh, Arfon Smith, Dana Solav, Claudia Solis-Lemus, Charlotte Soneson, Evan Walter Clark Spotte-Smith, Andrew Stewart, Marcel Stimberg, Fabian-Robert Stöter, Øystein Sørensen, Fei Tao, George K.  Thiruvathukal, Kristen Thyng, Ana Trisovic, Adam Tyson, Chris Vernon, Marcos Vital, Anastassia Vybornova, Rachel Wegener, Britta Westner, Lucy Whalley, Ethan White, Frauke Wiese, Mengqi Zhao, and Bonan Zhu\end{center}
}
...
\column{0.5} \block{About}{The Journal of Open Source Software (JOSS)
  ...
  Latest paper about JOSS: \footnotesize Diehl, Patrick, et al.\ "The Journal of Open Source Software (JOSS): Bringing Open-Source Software Practices to the Scholarly Publishing Community for Authors, Reviewers, Editors, and Publishers." Journal of Librarianship and Scholarly Communication 12.2 (2025). https://doi.org/10.31274/jlsc.18285}
...
\block{Publication workflow}{
  \begin{center}
    ...
    Credit: Niemeyer, K. (2017). JOSS publication flowchart. figshare. https://doi.org/10.6084/m9.figshare.5147773.v2
  \end{center}
}
...
Presented by Patrick Diehl, Will Gearty, and Daniel S. Katz at the \emph{3nd Annual Conference of the US Research Software Engineering Association} in Philadelphia, PA, 6--8 Oct 2025. \\
LA-UR-24-28030\\
