...
\block{Publication statistics}{
  ...
  \begin{tabular}{p{0.62\linewidth}@{\quad}cc}
    ...
    \href{http://dx.doi.org/10.21105/joss.01686}{Welcome to the Tidyverse} & 2019-11-21 & 9\,431 \\
    \href{http://dx.doi.org/10.21105/joss.00861}{UMAP: Uniform Manifold Approximation and Projection}
    & 2018-09-02 & 4\,858 \\
    \href{http://dx.doi.org/10.21105/joss.03021}{seaborn: statistical data visualization} & 2021-04-06 & 2\,652 \\
    \href{http://dx.doi.org/10.21105/joss.03139}{performance: An R Package for Assessment, Comparison and Testing of Statistical Models} & 2021-04-21 & 1\,574 \\
    \href{http://dx.doi.org/10.21105/joss.00024}{corner.py: Scatterplot matrices in Python} & 2016-06-08 & 1\,313 \\
  \end{tabular}
  \end{center}
}
...
% %   & \textbf{JOSS homepage} \\
% %   & \url{https://joss.theoj.org} \\
%       Presented by Warrick Ball at the \emph{Seventh Annual Conference for Research Software Engineering}
%       (RSECon23) at Swansea University, 5-7 Sep 2023. \includegraphics[width=0.15\textwidth]{by.png} &
%       \textbf{JOSS homepage}
%        \\
